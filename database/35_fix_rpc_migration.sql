-- ============================================================
-- FIX: DROP AND RECREATE SUPER ADMIN RPCs
-- ============================================================
-- Resolve "cannot change return type" error by dropping first.

DROP FUNCTION IF EXISTS public.create_platform_user;
DROP FUNCTION IF EXISTS public.delete_platform_user;
DROP FUNCTION IF EXISTS public.toggle_user_status;
