    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm no-print">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3 cursor-pointer select-none" onClick={() => setActiveView(isOrderMode ? 'create-order' : 'dashboard')}>
            <img src="/images/logo/QuickServe-logo-black.png" alt="Logo" className="h-8 w-auto mix-blend-multiply object-contain" />
            <div className="hidden sm:block"> 
              <h1 className="font-['Outfit'] text-xl font-bold text-gray-900 tracking-tight leading-none mb-0.5 translate-y-[2px]">QuickServe POS</h1>
              {isOrderMode && <span className="text-[10px] uppercase font-bold tracking-wider bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded">Order Mode</span>}
              {!isOrderMode && <p className="text-[10px] text-gray-500 font-medium tracking-wide uppercase">by Spacelinkers</p>}
            </div>
          </div>
